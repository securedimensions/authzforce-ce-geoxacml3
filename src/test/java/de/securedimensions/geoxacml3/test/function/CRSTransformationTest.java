...
public class CRSTransformationTest extends GeometryFunctionTest {
    ...
    public static Collection<Object[]> params() {
        ...
        return Arrays.asList(
                ...
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMSRS4326), new GeometryValue(gWMCRS84)), BooleanValue.TRUE},

                // CRS transformation required -> Core conformance would throw an error
                // transformation of gWMCRS84AllowTransformation
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMCRS84AllowTransformation), new GeometryValue(gWMSRID3857)), BooleanValue.TRUE},
                // transformation of gWMSRS4326AllowTransformation
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMSRS4326AllowTransformation), new GeometryValue(gWMSRID3857)), BooleanValue.TRUE},

                // CRS transformation required -> Core conformance would throw an error
                // transformation of gWMCRS84AllowTransformation
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMSRID3857), new GeometryValue(gWMCRS84AllowTransformation)), BooleanValue.TRUE},
                // transformation of gWMSRS4326AllowTransformation
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMSRID3857), new GeometryValue(gWMSRS4326AllowTransformation)), BooleanValue.TRUE},

                // CRS transformation not allowed per 'allowTransformation' attribute in AttributeValue -> throw Indeterminate
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMCRS84), new GeometryValue(gWMSRID3857)), null},
                new Object[]{TopologicalFunctions.Equals.ID, Arrays.asList(new GeometryValue(gWMSRS4326), new GeometryValue(gWMSRID3857)), null},
