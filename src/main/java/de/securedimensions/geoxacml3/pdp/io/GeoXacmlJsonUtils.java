 ...
 */
public final class GeoXacmlJsonUtils {
    /**
    ...
    private GeoXacmlJsonUtils() {
        // hide constructor
    }

    private static Schema loadSchema(String schemaFilenameRelativeToThisClass) {
        try (InputStream inputStream = GeoXacmlJsonUtils.class.getResourceAsStream(schemaFilenameRelativeToThisClass)) {
     ...
     *
     * @param xacmlJsonResponse input XACML Response
